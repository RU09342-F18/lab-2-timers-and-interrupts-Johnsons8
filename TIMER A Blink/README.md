The first option for this code has a timer interupt that used TIMER A predivided by 8, and cycling every 50000 ns. when the button is held down the lights toggle every 15000 ns.
